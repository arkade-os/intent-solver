...
Set `SOLVER_LATENCY_DIAGNOSTICS` to `1` to log per RFQ relay and Lightning receive quote
stage timings in `relay` mode. It is off by default. See `docs/runbook.md` for
the emitted fields.
