...
| `COVCLAIMD_URL` | none | unset = receive legs claim nothing on a client's behalf (the client claims its own lockup); set = funded lockups are revealed to the claim daemon so offline users still get paid |
