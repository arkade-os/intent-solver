...
(*                                                                         *)
(* DISAGREEMENT, UNRESOLVED.  EvmSend.cfg records 21,513,363 generated at  *)
(* 19min 58s, and the coverage note at the end of this module cites that   *)
(* figure too.  Same CFG, but a SEPARATE EXECUTION of it: the runtimes     *)
(* differ, which is what rules out a mistranscription of one run.          *)
(* Distinct (2,841,354) and depth (48) agree across both; only GENERATED   *)
(* differs.  NEEDS ONE CLEAN RE-RUN of EvmSend.cfg to settle which belongs *)
(* to the current spec.  Until then the distinct/depth pair is the fact to *)
(* compare against; treat generated as indicative.                         *)
(*                                                                         *)
(* FINDINGS                                                                *)
(*                                                                         *)
