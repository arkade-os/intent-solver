...
(* 13,556,587 states generated, 1,817,286 distinct, depth 46, 10min 10s    *)
...
(*                             NoDoubleLock violated, depth 9 (3,135/663)  *)
(*   EvmSend_NoReceipt.cfg     RefundSeesClaim = FALSE (shipped)           *)
(*                             NoSilentLoss violated, depth 15 (58,614/    *)
(*                             10,991)                                     *)
(*   EvmSend_BlindScan.cfg     TxidPatchAtomic = FALSE (shipped)           *)
(*                             NoNetLoss violated, depth 21 (409,038/      *)
(*                             61,533)                                     *)
(*   EvmSend_LateLock.cfg      LockLandsPromptly = FALSE (shipped)         *)
(*                             NoSilentLoss violated, depth 15 (60,670/    *)
(*                             11,365)                                     *)
