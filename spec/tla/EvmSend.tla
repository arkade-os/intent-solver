...
(*                                                                         *)
(* DISAGREEMENT, UNRESOLVED.  EvmSend.cfg records 21,513,363 generated for *)
(* this same run, at 19min 58s, and the coverage note at the end of this   *)
(* module cites that figure too.  Distinct (2,841,354) and depth (48)      *)
(* agree everywhere; only GENERATED differs, and the differing runtimes    *)
(* say these are two runs rather than one mistranscription.  NEEDS ONE     *)
(* CLEAN RE-RUN of EvmSend.cfg to settle which belongs to the current      *)
(* spec.  Until then the distinct/depth pair is the fact to compare        *)
(* against; treat generated as indicative.                                 *)
(*                                                                         *)
(* FINDINGS                                                                *)
(*                                                                         *)
