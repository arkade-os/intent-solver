...
(*                                 -> NoSilentLoss violated.  State count  *)
(*                                 not recorded.                           *)
...
(* MempoolExclusive = FALSE.  The count is the pre-(A9) run's and has not  *)
(* been re-measured.  The first 18 states are identical; then:             *)
(*                                                                         *)
